...
class QMatchBoxNet80k(nn.Module):    
    def __init__(self, preprocessing_mode:str) -> None:
        ...
        self.QJasperBlock0 = nn.Sequential(
            QuaternionConv(in_channels=40, out_channels=64, kernel_size=11, stride=(1,), padding=5, groups =1 , bias= False),
    ...
    def forward(self,x):
        ...
        if self.preprocessing_mode == "audio":
            ...
            o=x.squeeze() # since you are choosing off make sure jasper block 0 takes 4 as input channel
            # print("hello")
...
# m = QMatchBoxNet80k(preprocessing_mode='off')
