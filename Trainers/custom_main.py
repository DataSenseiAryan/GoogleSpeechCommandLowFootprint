...
from Models import bc_resnet_model

from Trainers import train
from Utils import apply, util, get_data
...
from Models.BCQnobias import QBcnobias
...
def train_command(scale, batch_size, device, epoch, log_interval, checkpoint_file, optimizer, dropout, subspectral_norm):
    ...
    model = QBcnobias(n_class=35, scale=6,dropout=0.2,use_subspectral=True).to(device=device)
